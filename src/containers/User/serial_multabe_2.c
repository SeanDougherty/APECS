...
void c_free_setup(struct SetupVars* setupvars) {
    ...
    free(setupvars->Y);
    free(setupvars->g2); 
    free(setupvars->T_1a1); 
    free(setupvars->T_1a2); 
    free(setupvars->T_2a2); 
    free(setupvars->T_2a3); 
    free(setupvars->T_3a1); 
    free(setupvars->T_3a3); 
    free(setupvars->S_1_1_u1); 
    free(setupvars->g1); 
    free(setupvars->coeff_auth1_u1_0); 
    free(setupvars->coeff_auth1_u1_1); 
    free(setupvars->S_1_2_u1); 
    free(setupvars->S_2_2_u1); 
    free(setupvars->coeff_auth2_u1_0); 
    free(setupvars->coeff_auth2_u1_1); 
    free(setupvars->S_2_3_u1); 
    free(setupvars->coeff_auth3_u1_0); 
    free(setupvars->coeff_auth3_u1_1);
    free(setupvars->S_3_1_u1); 
    free(setupvars->S_3_3_u1); 
    free(setupvars->D_u1); 
    free(setupvars->temp_1_GT); 
    free(setupvars->temp_1_Zr); 
    free(setupvars->temp_2_Zr);
    free(setupvars->e_g1g2);
    free(setupvars);
}

void c_free_encrypt(struct EncryptVars* encryptvars) {
        // EncryptVars
    free(encryptvars->E_0); 
    free(encryptvars->E_1); 
    free(encryptvars->C_1_1); 
    free(encryptvars->C_1_2); 
    free(encryptvars->C_2_2); 
    free(encryptvars->C_2_3); 
    free(encryptvars->C_3_1); 
    free(encryptvars->C_3_3); 
    free(encryptvars->msg); 
    free(encryptvars->s); 
    free(encryptvars->L1_0_Auth1); 
    free(encryptvars->L2_0_Auth1); 
    free(encryptvars->L2_0_Auth2); 
    free(encryptvars->L3_0_Auth2); 
    free(encryptvars->L1_0_Auth3); 
    free(encryptvars->L3_0_Auth3); 
    free(encryptvars);
}
...
struct SetupVars* c_setup() {
    ...
    */
    ...
    setupvars->Y = (unsigned char *) malloc(n);
    setupvars->Y_len = n;
    ...
    setupvars->g2 = (unsigned char *) malloc(n);
    setupvars->g2_len = n;
    ...
    setupvars->coeff_auth1_u1_0_len = n;
    ...
    setupvars->coeff_auth1_u1_1_len = n;
    ...
    setupvars->coeff_auth2_u1_0_len = n;
    ...
    setupvars->coeff_auth2_u1_1_len = n;
    ...
    setupvars->coeff_auth3_u1_0_len = n;
    ...
    setupvars->coeff_auth3_u1_1_len = n;
