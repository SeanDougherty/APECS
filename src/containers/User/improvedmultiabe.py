...
def setup():
    ...
    #need to convert this to dict in future
    ...
    #Compose a dictionary for easy serailization
    ...
    return Y, g2, T_1a1, T_1a2, T_2a2, T_2a3, T_3a1, T_3a3, q, S_1_1_u1, g1, coeff_auth1_u1, S_1_2_u1, S_2_2_u1, coeff_auth2_u1, S_2_3_u1, S_3_1_u1, coeff_auth3_u1, S_3_3_u1, D_u1, group, setup_dict
...
########DECRYPTION###########
def decrypt2(setup_dict, encrypt_dict):
